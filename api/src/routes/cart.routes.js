...
import { addToCart,  getCartDetails, getCartItemsById, removeAllCart, removeOneCart,removeItemQuantityCart, updateCouponValue } from "../controller/cart.controller.js";
// import { upload } from "../middleware/multer.middlware.js";
// import {
//   addToCart,
//   getCartDetails,
...
/// update price after add coupon
// cartRouter.route("/updateCart").post(
//   // authenticate,
//   verifyToken,
...
cartRouter.route("/updatecart").put(verifyToken,  updateCouponValue);
