...
const Footer = () => {
  ...
  const facebookLink = "https://www.facebook.com/profile.php?id=61566449916152&mibextid=ZbWKwL";
  const twitterLink = "https://twitter.com/";
  const instagramLink = "https://www.instagram.com/apalabajar";
      ...
      <div className="container mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-5 gap-10 px-5">
        ...
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li><Link to="/myprofile/my-wishlist" className="hover:text-orange-500">Wishlist</Link></li>
